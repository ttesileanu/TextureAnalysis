...
% [imgs,optsused,errs,metro]=btc_makemaps(method,opts,dict,auxopts) makes one or more
% textures based on a "method" (from btc_augcoords)
%
% beginning 26 Jan 15:  add extension to multiple gray levels
% beginning 01 Oct 15:  add extension for FLFS
%
...
%   method.p2x2: [2x2x2x2] array of probabilities,  Pickard conditions and normalization not checked
...
%
% output:
% imgs: the images requested, 0 or 1, size=[opts.area(1) opts.area(2) opts.nmaps]
...
%   GENMRFM_1D, MAPUBI, BTC_DIMRF, BTC_NOPICK, DONUT_METRO, MTC_FLFS_MAKEMAPS.
%
