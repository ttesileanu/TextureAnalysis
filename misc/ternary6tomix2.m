...
%   2-component representation, the n x 2 matrix `vecs2`. The directions in
%   the two planes are also inferred, and returned in the 2-component
%   vector `dirs`. In this vector, 0 represents the probability vector
%   [1, 0, 0], 1 represents [0, 1, 0], and 2 represents [0, 0, 1].
